...
Namespace Ajax.JSON
	Friend Class ArrayListConverter
        ...
        Public ReadOnly Property SupportedTypes() As Type() Implements IAjaxObjectConverter.SupportedTypes
            Get
                Return New Type() {GetType(ArrayList)}
            End Get
        End Property
        ...
        Public Sub ToJSON(ByRef sb As StringBuilder, o As Object) Implements IAjaxObjectConverter.ToJSON
            If o.[GetType]() Is GetType(ArrayList) OrElse o.[GetType]().BaseType Is GetType(ArrayList) Then
                Dim arrayList As ArrayList = CType(o, ArrayList)
                sb.Append("[")
                For i As Integer = 0 To arrayList.Count - 1
                    DefaultConverter.ToJSON(sb, arrayList(i))
